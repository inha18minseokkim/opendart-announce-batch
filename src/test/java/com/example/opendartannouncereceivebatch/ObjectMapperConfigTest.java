...
class ObjectMapperConfigTest {
    ...
    void freeIssueMappingTest() throws JsonProcessingException {
        ...
        log.info(jsonString);
        AnnounceFreeIssueElement announceFreeIssueElement1 = objectMapper.readValue(jsonString, AnnounceFreeIssueElement.class);
        log.info(announceFreeIssueElement1.toString());
        AnnounceFreeIssueElement announceFreeIssueElement = objectMapper.convertValue(jsonString, AnnounceFreeIssueElement.class);
