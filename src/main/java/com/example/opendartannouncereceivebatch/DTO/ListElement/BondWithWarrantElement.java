...
@AllArgsConstructor
@Builder
public class BondWithWarrantElement implements EssentialResponseElement{
    ...
    private String exPrc; //	신주인수권에 관한 사항(행사가액 (원/주))
    ...
    private String nstkIsstkCnt; //	신주인수권에 관한 사항(신주인수권 행사에 따라 발행할 주식(주식수))
    private String nstkIsstkTisstkVs; //	신주인수권에 관한 사항(신주인수권 행사에 따라 발행할 주식(주식총수 대비 비율(%)))
    private String expdBgd; //	신주인수권에 관한 사항(권리행사기간(시작일))
    private String expdEdd; //	신주인수권에 관한 사항(권리행사기간(종료일))
    private String actMktprcflCvprcLwtrsprc; //	신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(최저 조정가액 (원)))
    private String actMktprcflCvprcLwtrsprcBs; //	신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(최저 조정가액 근거))
    private String rmislmtLt70p; //	신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(발행당시 행사가액의 70% 미만으로 조정가능한 잔여 발행한도 (원)))
